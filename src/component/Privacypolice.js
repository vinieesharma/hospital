...
const Privacypolice = () => {
  return (
   <>
   <div className='privacy-contaoner' style={{width:'90%',margin:'auto' ,lineHeight:'40px'}}>

 
   <h1 style={{paddingTop:'100px',textAlign:'center'}}>Privacy Policy</h1>
...
<li>
<p><strong>Website</strong> refers to sloane virtual hospital, accessible from <a href="http://www.sloanevirtualhospital.com">Sloanevirtual hospial</a></p>
</li>
<li>
