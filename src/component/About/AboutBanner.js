...
import './AboutBanner.css'; // Import custom CSS
    ...
    return (
        <div className="aboutbanner">
            <div className="aboutbanner-content">
                ...
                <p>
                    sloane virtual hospital offers online healthcare services.
                </p>
          ...
          <button className="btn btn2 services"> Our Services</button>
                ...
                <div className="aboutschedule-container">
                    {/* <hr className="divider" /> */}
                    <div className="schedule-texts">
                        <a href=''>
                            <span className="schedule-text">Support online 24/7 <br />
                        ...
                        <a href='/bookappointment' alt='bookappoinment'>
